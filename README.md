...
```html
<script src="https://morofynn.github.io/ai-image-marker/ai-image-marker.js" defer></script>
```

Dieser Link bleibt bei allen Updates gleich und wird direkt aus dem `main`-Branch veröffentlicht.
